...
function MainContetn() {
  ...
  const current = destinations.find((d) => d.name === activeTab);

  return (
    <div className="2xl:p-[7%] 2xl:px-[11%] xl:px-[16%] 2xl:pb-[12%] xl:p-[5%] xl:pb-[10%] h-screen relative sm:p-[8%] p-[3%]">
        ...
        >
          ...
          <div className="flex w-full px-4 py-5">
            <div className="flex-1">
              <p className="2xl:text-lg sm:text-sm text-xs sm:text-left text-center">AVG. DISTANCE</p>
              <p className="2xl:text-3xl md:text-xl sm:text-left text-center">{current.dest}</p>
            </div>
            <div className="flex-1">
              <p className="2xl:text-lg sm:text-sm text-xs sm:text-left text-center">Est. travel time</p>
              <p className="2xl:text-3xl md:text-xl sm:text-left text-center">{current.travel}</p>
            </div>
          </div>
        </div>
      </div>
