  ...
  return (
    <div className="xl:flex xl:justify-end xl:items-center h-full w-full md:block">
      <div className="xl:w-[48%] xl:flex-1 xl:items-center xl:text-left md:block md:w-full text-center">
        <p className="text-white 2xl:text-3xl xl:text-lg xl:pb-4 font-light md:text-2xl pb-8">
          SO, YOU WANT TO TRAVEL TO
        </p>
        <span className="font-serif font-bold 2xl:text-9xl xl:text-7xl text-white sm:text-9xl text-6xl">SPACE</span>
        <p className="text-white pt-10 2xl:text-2xl xl:text-sm md:text-sm text-xs">
